...
public final class Picture implements ActionListener {
   ...
   /**
    ...
    public Color get(int i, int j) {
        if (i < 0 || i >= width())  throw new IndexOutOfBoundsException("i must be between 0 and " + (width()-1));
        if (j < 0 || j >= height()) throw new IndexOutOfBoundsException("j must be between 0 and " + (height()-1));
   ...
   /**
    ...
    public void set(int i, int j, Color c) {
        if (i < 0 || i >= width())  throw new IndexOutOfBoundsException("i must be between 0 and " + (width()-1));
        if (j < 0 || j >= height()) throw new IndexOutOfBoundsException("j must be between 0 and " + (height()-1));
        if (c == null) throw new NullPointerException("can't set Color to null");
